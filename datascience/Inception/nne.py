import keras
import numpy as np
from Inception.utils import calculate_metrics
from Inception.utils import create_directory
from Inception.utils import check_if_file_exits
import gc
import time
...
class Classifier_NNE:
    ...
    def create_classifier(self, model_name, input_shape, nb_classes, output_directory, verbose=False,
        ...
        if self.check_if_match('inception*', model_name):
            from Inception.inception import Classifier_INCEPTION
