...
class App {
  ...
  constructor() {
      ...
      const scene = new Scene(engine);
        ...
        function heart1(){ SceneLoader.ImportMesh("", "./", "heart_animation.babylon", scene, (meshes) => {
            
            const light = new HemisphericLight("light", new Vector3(500, 500, 5000), scene);
            light.intensity = 100;
            ...
            scene.registerBeforeRender(function () {
                ...
                for (const mesh of meshes) {
                    ...
                    if (mesh.scaling.x < 1.5 && scale || mesh.scaling.y < 1.5 && scale || mesh.scaling.z < 1.5 && scale ) {
                    ...
                    if (mesh.scaling.x > 0.8 && !scale || mesh.scaling.y > 0.8 && scale || mesh.scaling.z > 0.8  && scale ) {
